        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav ml-1">
                <li class="nav-item ml-1">
                    <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#modalRegistrarse">Registrar</button>
                </li>
                <li class="nav-item ml-1">
                    <button class="btn btn-sm btn-secondary" type="button" data-toggle="modal" data-target="#modalInicioSesion">Entrar</button>
                </li>
            </ul>
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <div class="card " style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><i class="fas fa-hand-holding-usd"></i> 10.000 </p>
                                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modalInformacionUsuario" >Informacion</a>
                                </div>
                            </div>
